...
Este projeto foi desenvolvido para abordar questões gerais, fornecendo soluções que demonstram simplicidade e lógica. O presente projeto pode ser útil para estudantes iniciantes no conteúdo, a fim de treinarem os conhecimentos básicos em C#. Os assuntos abordados variam entre: cálculos matemáticos, conversões de unidades, manipulação de strings, estrutura de dados, operações de listas, entre outros.
...
78. Crie uma função que simula uma fila de atendimento (FIFO) usando List.
